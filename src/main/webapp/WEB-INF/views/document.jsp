...
<head>
    ...
    <style>
        ...
        * {
        ...
        .modal_manager .content_info ul li .desc1 {
            font-weight: 400;
            width: 50px;
            position: relative;
            z-index: 1;
        ...
        .modal_manager .content_info ul li .desc1::after {
            position: absolute;
            left: 0;
            top: 15px;
            content: '';
        ...
        .modal_manager .content_info ul li .desc2 {
            width: calc(100% - 65px);
            font-weight: 400;
            opacity: .5;
            word-break: keep-all;
        ...
        <div class="swiper main_swiper swiper-container-initialized swiper-container-vertical">
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $('.main_wrap .side_menu ul li i.xi-group').click(function () {
