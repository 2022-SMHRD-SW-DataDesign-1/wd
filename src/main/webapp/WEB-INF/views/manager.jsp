...
.b_type1:hover, .b_type2:hover, .b_type3:hover, .b_type4:hover {
	color: #fff;
...
.main_wrap .main_header ul li:hover a::after, .main_wrap .main_header ul li.on a::after
	{
	width: 100%;
}
...
.main_wrap .main_header ul li:hover a, .main_wrap .main_header ul li.on a
	{
	color: var(- -color-fff);
}
...
.main_wrap .side_menu ul li:hover::before, .main_wrap .side_menu ul li:hover::after
	{
	left: calc(100% + 20px);
	visibility: inherit;
	opacity: 1;
...
.modal_logout .bg, .modal_clear .bg {
...
.modal_logout .container, .modal_clear .container {
	display: flex;
	background: var(- -color-1a1e23);
	border: 4px solid var(- -color-000);
	border-radius: 30px;
...
.modal_logout.on .container, .modal_clear.on .container {
	transform: translateY(0);
}

.modal_logout .container .xi-close-thin, .modal_clear .container .xi-close-thin
	{
	position: absolute;
	left: 50%;
	top: 0;
...
.modal_logout .container .xi-close-thin::before, .modal_clear .container .xi-close-thin::before
	{
	transition: all .3s ease;
}

.modal_logout .container .xi-close-thin:hover::before, .modal_clear .container .xi-close-thin:hover::before
	{
	transform: rotate(180deg);
}

.modal_logout .content_info, .modal_clear .content_info {
	display: flex;
	flex-direction: column;
	margin: 0 auto;
}

.modal_logout .content_info h2, .modal_clear .content_info h2 {
	color: var(- -color-fff);
	font-size: 36px;
	font-weight: 700;
	margin-bottom: 30px;
...
.modal_logout .content_info ul, .modal_clear .content_info ul {
	display: flex;
	flex-direction: column;
	gap: 15px 0;
}

.modal_logout .content_info ul li, .modal_clear .content_info ul li {
	font-size: 18px;
	color: var(- -color-fff);
	display: flex;
	gap: 15px;
...
.sec4::before {
	...
	width: 100%;
	height: 100%;
	background: url(./resources/images/big_img1_blur.png) no-repeat center/100%
		100%;
	z-index: -1;
}
...
.sec4 .input_group ul li input, .sec4 .input_group ul li textarea {
	background: none;
	width: 100%;
	border-radius: 5px;
...
<body>
	...
	<div class="main_wrap">
		<div
			class="swiper main_swiper swiper-container-initialized swiper-container-vertical">
			<div class="main_header">
				<a href="" class="logo">
					<div class="img">
						<img src="./resources/images/weed_log2.jpg">
					</div> <span class="en"> <b>WHO WITH SERVICE</b></span>
				</a>
				<ul class="gnb">
			...
			<!-- 추가 -->
			<section class="swiper-slide sec4"
				style="height: 881px; margin-bottom: 30px;">
				<div class="container">
					...
					<!-- 목록 세부내용 -->
					<div class="input_group" style="height: 70%;">
						<form id="frm" method="post" action="/requst-post-normal"
							target="ifrm" novalidate="novalidate">
							<input name="table" type="hidden" value="contact"
								autocomplete="off">
							<div class="group">
								<div class="tit">
